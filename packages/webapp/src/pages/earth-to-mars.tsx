    ...
    <Box w={"100%"} bg={"#1A1F2C"} color={"#e3e7f2"}>
      <Flex alignItems={"center"} justifyContent={"center"} gap={"16px"}>
        <Box textAlign={"center"} minW={"200px"}>
          <Link href="/">
            <Box>
              <Text fontSize={["38px"]} color={"brand.green"}>
                Real Software
              </Text>
              <Text fontSize={["24px"]} color={"brand.green"}>
                Real-world impact through vision, resilience, and meaningful
                results
              </Text>
            </Box>
          </Link>
      ...
      >
        ...
        <Box my={"40px"}>
          <Text fontSize={"28px"}>
            This line graph illustrates the changing distance between Earth and
            Mars over time, with the calculations based on NASA's Jet Propulsion
            Laboratory SPICE data.
          </Text>
        </Box>
        <Box margin={"0 auto"}>
          <iframe
